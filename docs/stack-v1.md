...
已复核、**不得进内置清单**的字体（免得日后重复踩）：

| 字体                              | 结论                                                                                                                                                | 依据                                                                                             |
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ |
| 汉仪新蒂馆阁体、新蒂永乐大典      | 仅个人非商用；协议禁「以任何技术方式对外提供字体」                                                                                                  | 汉仪《个人非商用许可协议》三(4)                                                                  |
| 全字库说文解字字型（ebas927.ttf） | 下载页但书「適用對象：個人與系統發展使用」；**不在** data.gov.tw 全字库开放数据集内（该数据集只含 Fonts_Sung／Fonts_Kai，双授权 OGDL-1.0／OFL-1.1） | [字型下載頁](https://www.cns11643.gov.tw/downloadList.jsp?ID=2&ID2=20)；字体版权字段署 CMEX 2004 |

说文解字字型技术上完全可用（6745 字全在标准 CJK 码位、无造字区；繁体命中 86–95%，简体仅 57%），
只是授权只到「个人使用」——故走本机字体库。
